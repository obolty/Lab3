	...
	public MainFrame(Double[] coefficients) {
		...
		Action aboutInfoAction = new AbstractAction("О программе") {
			public void actionPerformed(ActionEvent event) {
				JOptionPane.showMessageDialog(MainFrame.this, "Мазаник Евгений, 6 группа", "О программе",
						JOptionPane.INFORMATION_MESSAGE);
			}
		};
		// Добавить соответствующий пункт подменю в меню "Справка"
		aboutMenuItem = aboutMenu.add(aboutInfoAction);
		...
		buttonCalc.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				try {
					...
					// Удалить все вложенные элементы из контейнер hBoxResult
		...
		hBoxResult.add(new JPanel());
		// Установить контейнер hBoxResult в главной (центральной) области граничной
		// компоновки
...
// обрабатывать, так как мы файл создаѐм, а не открываем
	...
	public static void main(String[] args) {
		...
		// Зарезервировать места в массиве коэффициентов столько, сколько аргументов
		// командной строки
